(function attachPageState(global) {
  ...
  function createSidebarState() {
    return {
      ...
      serviceMarketExpanded: false,
      serviceSettlementExpanded: false,
      serviceMerchantExpanded: false,
      saleExpanded: false,
      ...
      customerServiceExpanded: false,
      algorithmExpanded: false,
      storageExpanded: false,
      storageProjectExpanded: false,
      storageOperationExpanded: false,
      storageRevenueExpanded: false,
      storageGovernanceExpanded: false,
      dispatchExpanded: false,
      columbusExpanded: false,
