(function attachInfoDisclosureConfig(global) {
  global.BOSS_INFO_DISCLOSURE_CONFIG = {
    ...
    loadInfoTabConfig: {
      ...
      hn: [
        { key: "loadInfo", label: "负荷信息", hasDataSource: true, order: 1 },
        { key: "tieLine", label: "省间联络", hasDataSource: true, order: 2 },
        { key: "thermalBiddingSpace", label: "火电竞价空间", hasDataSource: true, order: 3 },
        { key: "reserveInfo", label: "备用信息", hasDataSource: true, order: 4 },
        { key: "unitStatus", label: "机组状态", hasDataSource: true, order: 5 },
        { key: "transmissionMaintenancePlan", label: "发输变电设备检修计划", hasDataSource: true, order: 6 },
        { key: "unitMaintenanceCapacity", label: "机组检修容量", hasDataSource: false, order: 7 },
      ],
      sx: [
        { key: "loadInfo", label: "负荷信息", hasDataSource: true, order: 1 },
        { key: "tieLine", label: "省间联络", hasDataSource: true, order: 2 },
    ...
    secondaryTabs: {
      ...
      "中长期合同曲线": ["中长期合同曲线汇总", "中长期合同曲线明细"],
      "交易总体情况": ["中长期批发市场净合同加权均价"],
      "零售用户结算情况": ["批发购电分时均价"],
    },
    dataSourceAccess: {
      guangdong: {
